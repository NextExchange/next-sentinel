...
from nextd import nextdaemon
import nextlib
from decimal import Decimal
nextd = nextdaemon.from_next_conf(config.next_conf)
import misc
# ==============================================================================
# do stuff here
...
pr = Proposal(
    name='proposal7',
    url='https://nextcentral.com/proposal7',
